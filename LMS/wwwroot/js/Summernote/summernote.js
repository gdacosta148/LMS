        ...
        this.context.memo('button.floatCenter', function ()
        {
            return _this2.button({
                contents: _this2.ui.icon(
                    _this2.options.icons.floatCenter),
                tooltip: _this2.lang.image.floatCenter, click: _this2.context.createInvokeHandler('editor.floatMe', 'center')
            }).render();
        });
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    popatmouse: true,
    popover: {
        image: [['resize', ['resizeFull', 'resizeHalf', 'resizeQuarter', 'resizeNone']], ['float', ['floatCenter','floatLeft', 'floatRight', 'floatNone']], ['remove', ['removeMedia']]],
