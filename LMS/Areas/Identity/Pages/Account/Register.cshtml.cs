    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, Nombre = Input.Nombre, Ciudad = Input.Ciudad,
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.StudenUser))
                    {

                        await _roleManager.CreateAsync(new IdentityRole(SD.StudenUser));
                    }
                    ...
                    else if(role == SD.ManagerUser)
                    {
                        ...
                        //        await _userManager.AddToRoleAsync(user, SD.StudenUser);
                    ...
                    return RedirectToAction("Index", "User", new { area = "Usuarios" });
